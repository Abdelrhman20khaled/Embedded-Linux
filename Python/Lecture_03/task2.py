...
sleep(5)
#Serach for the picture and wait for 2 seconds, you should change the path of the picture 
#according to your environment
while location is None:
    location = py.locateCenterOnScreen('/home/abdelrahman/Embedded Linux/Pic_Scripts/another_op.png', confidence=0.9)
    sleep(2)
